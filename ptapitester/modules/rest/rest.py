...
class RESTArgs(Namespace):
    def get_help(self):
        ...
        return [
            {"description": ["Module for REST API testing"]},
            {"usage": ["ptapitester REST <options>"]},
            {"usage_example": [
                "ptapitester REST -u https://www.example.com",
            ]},
            {"options": [
...
def main(args: Namespace, common_tests: object):
    global SCRIPTNAME
    SCRIPTNAME = "rest"
    script = PtREST(args, common_tests)
    script.run()
